...
public extension View {
    func tahoeBackground(material: NSVisualEffectView.Material = .hudWindow, blending: NSVisualEffectView.BlendingMode = .behindWindow) -> some View {
        self.modifier(TahoeMaterial(material: material, blendingMode: blending))
    }
    
    func glow(color: Color = DesignSystem.Colors.accent, radius: CGFloat = 10) -> some View {
